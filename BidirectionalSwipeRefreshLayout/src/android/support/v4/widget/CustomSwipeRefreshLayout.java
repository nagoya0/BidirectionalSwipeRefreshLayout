...
public class CustomSwipeRefreshLayout extends ViewGroup {
    ...
    protected float mCurrPercentage = 0;
    ...
    protected final AccelerateInterpolator mAccelerateInterpolator;
    ...
    protected final Runnable mCancel = new Runnable() {
    ...
    protected void updateContentOffsetTop(int targetTop) {
        final int currentTop = mTarget.getTop();
    ...
    protected void setTargetOffsetTopAndBottom(int offset) {
        mTarget.offsetTopAndBottom(offset);
        mCurrentTargetOffsetTop = mTarget.getTop();
    }

    protected void updatePositionTimeout() {
        removeCallbacks(mCancel);
